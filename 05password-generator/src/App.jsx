...
function App() {
  ...
  // useCallback() Hook
  // passwordGenerator function -- usecallback() memorize karne ke liye
  ...
  const copyPasswordToClipboard = useCallback(() => {
    // password ko select karne ke liye
    passwordRef.current?.select();

    // jab range ke according selection karna ho
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-md px-4 py-4 my-8 text-orange-300 bg-gray-700">
        <h1 className="text-xl mb-2 text-center text-white">
          Password Generator
        </h1>
